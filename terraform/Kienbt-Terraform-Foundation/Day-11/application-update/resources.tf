...
resource "aws_autoscaling_group" "webapp_asg" {
  ...
  name                  = "dtt_webapp_ags-${terraform.workspace}"
...
resource "aws_autoscaling_policy" "scale_up" {
  name                   = "dtt_asg_scale_up-${terraform.workspace}"
...
resource "aws_autoscaling_policy" "scale_down" {
  name                   = "dtt_asg_scale_down-${terraform.workspace}"
...
resource "aws_db_subnet_group" "db_subnet_group" {
  name       = "${terraform.workspace}-ddt-rds-subnet_group"
